    ...
    nav.
      h3("Tools").
        ul().
          ...
          li().a("/jmx?qry=Hadoop:*", "Server metrics")._()._();
    
    nav.
    h3("Slow Tasks").
      ul().
        li().a(url("alltasks"), "All tasks")._().
        li().a(url("slowtasks", "elapsedtime", "0"), "Elapsed time")._().
        li().a(url("slowtasks", "gctime", "0"), "Gc time")._().
        li().a(url("slowtasks", "slowstart", "0"), "Slow start")._().
        li().a(url("slowtasks", "readdatalean", "0"), "Read DataLean")._().
        li().a(url("slowtasks", "writedatalean", "0"), "Write DataLean")._().
        li().a(url("slowtaskattempts"), "Error TaskAttempts")._()._()._();
  }
}
